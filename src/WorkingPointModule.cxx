  ...
  empty_output_tree(string2bool(ctx.get("empty_output_tree")))
{
  ...
  hists_ak8_before_corrections.reset(new AK8Hists(ctx, "AK8Hists_0_before_corrections"));
  hists_ak8_after_corrections.reset(new AK8Hists(ctx, "AK8Hists_1_after_corrections"));
  hists_ak8_after_cleaning.reset(new AK8Hists(ctx, "AK8Hists_2_after_cleaning"));

  hists_hotvr_before_corrections.reset(new HOTVRHists(ctx, "HOTVRHists_0_before_corrections", ctx.get("hotvrCollection_rec"), ctx.get("hotvrCollection_gen")));
  hists_hotvr_after_corrections.reset(new HOTVRHists(ctx, "HOTVRHists_1_after_corrections", ctx.get("hotvrCollection_rec"), ctx.get("hotvrCollection_gen")));
  hists_hotvr_after_cleaning.reset(new HOTVRHists(ctx, "HOTVRHists_2_after_cleaning", ctx.get("hotvrCollection_rec"), ctx.get("hotvrCollection_gen")));
}
