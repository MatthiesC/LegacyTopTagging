...
CommonHists::CommonHists(Context & ctx, const string & dirname, const unsigned int default_nbins): Hists(ctx, dirname) {
  ...
  hist_twodselection = book<TH2F>("twodselection", "#it{p}_{T}^{rel} [GeV] vs. #Delta#it{R}", default_nbins, 0, 5, default_nbins, 0, 500);
