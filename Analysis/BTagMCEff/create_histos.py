...
year_choices = ['UL17', 'UL18']

if not sys.argv[1:]: sys.exit('No arguments provided. Exit.')
parser = argparse.ArgumentParser()
parser.add_argument('-y', '--years', choices=year_choices, nargs='*', default=[])
...
for year in args.years:
    ...
    input_pattern = os.path.join(outputDir, year, 'nominal', 'uhh2.AnalysisModuleRunner.MC.*AllMergeScenarios*.root')
    ...
    outfile = os.path.join(histDir, 'BTagMCEfficiencyHists'+folder+'_'+year+'.root')
