    ...
    for pt_bin in tagger.var_intervals.values():
        ...
        for syst, syst_v in ({arg_syst.name: arg_syst}.items() if arg_syst else _SYSTEMATICS.items()):
            ...
            for syst, syst_v in ({arg_syst.name: arg_syst}.items() if arg_syst else _SYSTEMATICS.items()):
                ...
                outDir = os.path.join(outDirBase, 'BasicHists-Tau32')
...
if __name__ == '__main__':
    ...
    if the_tagger.name.startswith('ak8_t'):
        the_vars = [
            ...
            # 'output_probejet_AK8_mSD',  # choose this for jet mass plots
        ...
        the_vars = [
            ...
            # 'output_probejet_HOTVR_mass',  # choose this for jet mass plots
    ...
    for var in the_vars:
        for year in years:
            ...
            the_wp_indices = [-1]  # NullWP - for tau32 we do only look at inclusive distribution
            for syst in the_systs:
                for wp_index in the_wp_indices:
