...
def create_rearranged_hists(variable, tagger, year, wp, pt_bin, do_plot=False, do_hists=True, do_rebinning=True):
    ...
    if do_plot:
        ...
        for outFolderName in outFolderNames:
            ...
            tlatex_prepostfit = root.TLatex(nice.coord.graph_to_pad_x(0.54), nice.coord.graph_to_pad_y(0.82), pt_text_prepostfit)
            ...
            tline_prepostfit = root.TLine(nice.coord.graph_to_pad_x(0.56), nice.coord.graph_to_pad_y(0.22), nice.coord.graph_to_pad_x(0.56), nice.coord.graph_to_pad_y(0.84))
            ...
            tarrow_prepostfit = root.TArrow(nice.coord.graph_to_pad_x(0.56), nice.coord.graph_to_pad_y(0.79), nice.coord.graph_to_pad_x(0.42), nice.coord.graph_to_pad_y(0.79), 0.02, "|>")
