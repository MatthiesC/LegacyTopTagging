...
def create_rearranged_hists(variable, tagger, year, wp, pt_bin, do_plot=False, do_hists=True, do_rebinning=True):
    ...
    if 'both' in channels:
        outFileName = 'Templates-'+task_name+'-both.root' #hack
    ...
    if do_plot:
        ...
        for outFolderName in outFolderNames:
            ...
            tlatex_prepostfit = root.TLatex(nice.coord.graph_to_pad_x(0.51), nice.coord.graph_to_pad_y(0.88), pt_text_prepostfit)
